...
const Square = ({color}) => {
    ...
    <div className='square' style={color ? { backgroundColor: "white", height: squareDimension, width: squareDimension} : { backgroundColor: "black", height: squareDimension, width: squareDimension}}>
